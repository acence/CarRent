...
namespace CarRent.UnitTests.Application.UseCases.Cars.Handlers
{
    ...
    public class DeleteCarTests
    {
        ...
        public DeleteCarTests()
        {
            ...
            _carRepository.Setup(x => x.Delete(It.Is<Car>(x => x.Id == _successData.Id), It.IsAny<CancellationToken>()))
                .ReturnsAsync(1);
            _carRepository.Setup(x => x.Delete(It.Is<Car>(x => x.Id == _failData.Id), It.IsAny<CancellationToken>()))
                .ReturnsAsync(0);
        }
